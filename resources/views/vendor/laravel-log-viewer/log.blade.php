...
<div class="container-fluid">
  <div class="row">
    <div class="col sidebar mb-3">
      <a href="{{ route('home') }}"><h1><i class="fa fa-calendar" aria-hidden="true"></i> Log Viewer</h1></a>
      <p class="text-muted"><i>@ <a href="https://github.com/rap2hpoutre/laravel-log-viewer">Rap2h</a></p>
      <p class="text-muted"><i class="fa fa-door"></i><a href="{{ route('home') }}"> Go Back To Home</a></p>
