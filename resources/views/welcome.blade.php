...
<body style="overflow-x: hidden; background: #FFFFFF;">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <p class="card-text" id="announcement-{{ $ann->id }}">
                                        ...
                                        @if (strlen($ann->description) > 50)
                                            ...
                                            <a href="javascript:void(0)" class="see-more" style="display:inline;">See
                                                More</a>
                                            <a href="javascript:void(0)" class="see-less" style="display:none;">See
                                                Less</a>
                                        @endif
                                    </p>
                                </div>
                ...
                <div class="card mb-3 shadow-sm justify-content-center">
                    ...
                    <div class="card-body d-flex justify-content-center">
                        <iframe width="560" height="315"
                            src="https://www.youtube.com/embed/lQYV3m1J4gs?si=c4ECVQldz2ZQsg_N&amp;controls=0"
        ...
        <div class="row justify-content-center">
            <div class="col">
                <div class="card mb-3 shadow-sm justify-content-center">
                    ...
                    <div class="card-body d-flex justify-content-center">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15937.882070500256!2d104.74042730000001!3d-2.96686155!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e3b76094fcf39dd%3A0x8b4ee43321ad20a0!2sMDP%20IT%20Superstore!5e0!3m2!1sen!2sid!4v1734010496046!5m2!1sen!2sid"
    ...
    <div class="container-fluid py-2 d-flex align-items-center justify-content-center" style="min-height: 80px;">
